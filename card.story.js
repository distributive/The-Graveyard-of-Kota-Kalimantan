...
Agenda2 = new AgendaData("agenda_2", {
  ...
  requirement: 12,
  agenda: 1,
  text: "When this hosts 12 or more doom, lose all data, discard 2 random cards, and advance the agenda.",
  image: "img/card/agenda/agenda2.jpg",
...
Agenda3 = new AgendaData("agenda_3", {
  ...
  requirement: 7,
  agenda: 2,
  text: "When this hosts 7 or more doom, succumb to the void.",
  image: "img/card/agenda/agenda3.jpg",
  faction: FACTION_NET,
  async onDoomPlaced(data) {
    // For now we assume only the agenda can host doom
    if (data.doom >= this.requirement) {
...
Agenda4 = new AgendaData("agenda_4", {
  ...
  image: "img/card/agenda/agenda4.jpg",
  illustrator: "Photo by Andrew Amistad, Unsplash (modified)",
  faction: FACTION_NET,
  async onDoomPlaced(data) {
    // For now we assume only the agenda can host doom
