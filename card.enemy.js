...
const EnemyNetRat = new EnemyData("net_rat", {
  ...
  subtypes: ["ice"],
  faction: FACTION_NET,
  image: "img/card/enemy/netRat.jpg",
  strength: 2,
  health: 2,
  link: 4,
  isHunter: true,
...
const EnemyBurkeBug = new EnemyData("burke_bug", {
  ...
  subtypes: ["ice"],
  faction: FACTION_NET,
  image: "img/card/enemy/burkeBug.jpg",
  strength: 3,
  health: 3,
  link: 3,
  isHunter: true,
...
const EnemyAnansi = new EnemyData("anansi", {
  ...
  subtypes: ["ice"],
  faction: FACTION_NET,
  image: "img/card/enemy/anansi.jpg",
  strength: 5,
  health: 4,
  link: 4,
...
const EnemyArcher = new EnemyData("archer", {
  ...
  subtypes: ["ice"],
  faction: FACTION_NET,
  image: "img/card/enemy/archer.jpg",
  strength: 6,
  health: 1,
  link: 3,
...
const EnemyHydra = new EnemyData("hydra", {
  ...
  subtypes: ["ice"],
  faction: FACTION_NET,
  image: "img/card/enemy/hydra.jpg",
  strength: 4,
  health: 3,
  link: 3,
  async attack() {
...
const EnemyArchitect = new EnemyData("architect", {
  ...
  subtypes: ["ice"],
  faction: FACTION_NET,
  image: "img/card/enemy/architect.jpg",
  strength: 0,
  health: 10,
  link: 4,
  isHunter: true,
...
const EnemySurveyor = new EnemyData("surveyor", {
  ...
  faction: FACTION_NET,
  image: "img/card/enemy/surveyor.jpg",
  strength: 0,
  health: 4,
  link: 0,
...
const EnemyDataRaven = new EnemyData("data_raven", {
  ...
  subtypes: ["ice"],
  faction: FACTION_NET,
  image: "img/card/enemy/dataRaven.jpg",
  strength: 4,
  health: 2,
  link: 2,
  isHunter: true,
...
const EnemyHantu = new EnemyData("hantu", {
  ...
  flavour: "Her screams permeate your soul.",
  subtypes: ["ice", "elite"],
  faction: FACTION_NET,
  image: "img/card/enemy/hantu.jpg",
