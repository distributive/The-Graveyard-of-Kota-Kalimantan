...
CardDocklandsPass = new AssetData("docklands_pass", {
  ...
  image: "img/card/asset/docklandsPass.jpg",
  cost: 2,
  health: 0,
  skills: ["mu"],
...
CardPennyearner = new AssetData("pennyearner", {
  ...
  unique: true,
  faction: FACTION_CRIMINAL,
  image: "img/card/asset/pennyearner.jpg",
  cost: 3,
  health: 0,
  skills: ["mu", "link"],
...
CardAkauntan = new AssetData("akauntan", {
  ...
  unique: false,
  faction: FACTION_CRIMINAL,
  image: "img/card/asset/akauntan.jpg",
  cost: 3,
  health: 1,
...
CardForgedDocuments = new AssetData("forged_documents", {
  ...
  unique: false,
  faction: FACTION_CRIMINAL,
  image: "img/card/asset/forgedDocuments.jpg",
  cost: 1,
  health: 1,
  skills: ["link"],
...
CardCrowbar = new AssetData("crowbar", {
  ...
  unique: false,
  faction: FACTION_CRIMINAL,
  image: "img/card/asset/crowbar.jpg",
  cost: 3,
  health: 1,
...
CardSpike = new AssetData("spike", {
  ...
  unique: false,
  faction: FACTION_CRIMINAL,
  image: "img/card/asset/spike.jpg",
  cost: 3,
  health: 2,
  skills: ["influence", "mu"],
  // smallText: true,
...
CardBackflip = new EventData("backflip", {
  ...
  faction: FACTION_CRIMINAL,
  image: "img/card/event/parry.jpg",
  cost: 2,
  preventAttacks: true,
  skills: ["mu", "strength"],
  canPlay(source) {
...
CardZhanZhuang = new EventData("zhan_zhuang", {
  ...
  subtypes: ["talent"],
  faction: FACTION_CRIMINAL,
  image: "img/card/event/zhanZhuang.jpg",
  cost: 0,
  skills: ["influence", "strength"],
  async onPlay() {
...
CardJackOfAll = new EventData("jack_of_all_trades", {
  ...
  subtypes: ["talent"],
  faction: FACTION_CRIMINAL,
  image: "img/card/event/jackOfAll.jpg",
  cost: 1,
...
CardEmpDevice = new EventData("emp_device", {
  ...
  faction: FACTION_CRIMINAL,
  image: "img/card/event/empDevice.jpg",
  cost: 4,
  skills: ["strength"],
  preventAttacks: true,
  canPlay(source) {
...
CardInsideJob = new EventData("inside_job", {
  ...
  subtypes: ["tactic"],
  faction: FACTION_CRIMINAL,
  image: "img/card/event/insideJob.jpg",
...
CardTreadLightly = new EventData("tread_lightly", {
  ...
  faction: FACTION_CRIMINAL,
  image: "img/card/event/treadLightly.jpg",
